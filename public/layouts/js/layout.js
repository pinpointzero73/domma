...
(async function () {
    ...
    function injectStyles() {
      ...
      <style id="layout-styles">
        ...
        /* Corporate */
        .variant-dot-corporate-light { background: linear-gradient(135deg, #f8fafc, #1e40af); }
        .variant-dot-corporate-dark { background: linear-gradient(135deg, #0b0f19, #2563eb); }
        /* Admin */
        ...
        .variant-dot-admin-slate-steel { background: linear-gradient(135deg, #252c37, #3b76bc); }
        .variant-dot-admin-slate-indigo { background: linear-gradient(135deg, #252c37, #5b63a8); }
        .variant-dot-admin-slate-teal { background: linear-gradient(135deg, #252c37, #2a8178); }
        .variant-dot::after {
          content: attr(data-tooltip);
          position: absolute;
          right: 50px;
        ...
        const themeSelectorHtml = `
            <div class="${selectorClass}" id="variant-selector">
                ...
                <div class="variant-options">
                    ...
                    <button class="variant-dot variant-dot-corporate-light" data-theme="corporate-light" data-tooltip="Corporate Light ☀️"></button>
                    <button class="variant-dot variant-dot-corporate-dark" data-theme="corporate-dark" data-tooltip="Corporate Dark 🌙"></button>
                    ...
                    <button class="variant-dot variant-dot-admin-slate-steel" data-theme="admin-slate-steel" data-tooltip="Admin Slate · Steel"></button>
                    <button class="variant-dot variant-dot-admin-slate-indigo" data-theme="admin-slate-indigo" data-tooltip="Admin Slate · Indigo"></button>
                    <button class="variant-dot variant-dot-admin-slate-teal" data-theme="admin-slate-teal" data-tooltip="Admin Slate · Teal"></button>
                </div>
            </div>
        `;
